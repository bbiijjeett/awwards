...
const Loader = () => {
  ...
  return (
    <section id="loader" className="flex flex-col justify-between">
      ...
      <div
        id="text"
        className="select-none h-full mt-[100px] w-full tracking-tight flex flex-col justify-center items-center text-2xl md:text-8xl tk-freight-big-pro leading-8 md:leading-[5vw] "
      >
        <p>
