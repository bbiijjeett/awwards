  ...
  return (
    ...
    >
      ...
      <div className="flex gap-5 w-full border-t-[1px] pt-10 mt-20 border-zinc-500">
        ...
        <div className="w-1/2 h-[60vh] rounded-2xl bg-cover bg-[url('https://images.unsplash.com/photo-1682687221080-5cb261c645cb?q=80&w=1770&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]"></div>
      </div>
    </div>
  );
};
